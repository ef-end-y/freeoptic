...
$ajFibers = {
    ...
    'The cable to be connected to must be on another scheme' => 'Подключаемый кабель должен находиться на другой схеме',
    ...
    'Cable length is not specified' => 'У кабеля не задана длина',
    ...
    'Only 2 fibers in a solder' => 'Только 2 волокна в пайке',
