...
$ajFibers = {
    ...
    'want_a_personal_scheme' => 'Якщо посилання комусь відоме і вам потрібна персональна схема, експортуйте, створіть нову, імпортуйте',
    'this_is_fragment' => 'Ця схема є частиною іншої. Всі, хто має доступ до батьківської схеми, матимуть доступ до цієї',
    'The cable to be connected to must be on another scheme' => 'Кабель, що підключається, повинен знаходитися на іншій схемі',
    ...
    'Only 2 fibers in a solder' => 'Тільки 2 волокна в пайці',
...
$o_fibers_container_types = {
    ...
    'Новый тип' => 'Новий тип',
    'Все типы контейнеров' => 'Всі типи контейнерів',
