let settings = {
    ...
    mute_color: '#e3e3e3',
    change_scheme_detailization_zoom: 0.24
};
    ...
    style: [
        {
            ...
            selector: 'node[cls="frame"][type="panel"],node[cls="frame"][type="switch"]',
            style: {
                'border-color': '#8dc1f7'
            }
        },{
            selector: 'node[cls="frame"][type="coupler"]',
            style: {
                'border-color': '#c0c0c0'
            }
        },{
